    ...
    <Box sx={{ py: 12 }}>
      <Container>
        <FadeInUpBox>
          ...
          >
            Consume YouTube videos twice as fast. Time-coded transcriptions and
            video summary generated within seconds.
          </Typography>
        </FadeInUpBox>
        ...
        <Box sx={{ pt: 8 }}>
          <Grid container spacing={7}>
              ...
              <FadeInUpBox style={{ height: '100%' }}>
                <Card>
                  ...
                  <Typography sx={{ opacity: 0.8 }}>
                    Keep track of all the videos you might want to watch or
                    referr later on.
                  </Typography>
                </Card>
              </FadeInUpBox>
            ...
            <Grid item xs={7}>
              <FadeInUpBox index={4} style={{ height: '100%' }}>
                <Card>
                  <Box mb={2}>
